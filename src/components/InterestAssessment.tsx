...
const InterestAssessment: React.FC = () => {
  ...
  useEffect(() => {
    // Load interest questions directly from the consolidated file
    const loadedQuestions = getQuestionsByCategory('interest');
  ...
  const saveScoresToLocalStorage = () => {
    ...
    localStorage.setItem("interestTestScores", JSON.stringify(scoresObject));
  };
    ...
    <div className="max-w-3xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
      <div className="mb-6">
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Interest Assessment</h2>
